...
欢迎来到《寒蝉鸣泣之时》中文汉化补丁常见问题解答，你可以用页面顶端的**搜索栏**或者右边的**导航栏**快速定位你的问题。
...
- 如果文件是以 `.exe`、`.dll` 结尾的文件，那么这就是模拟版 Windows 应用，需要进行下一步操作。
