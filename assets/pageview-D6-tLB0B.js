...
若要上传大文件，可以先自行寻找图床或其他服务，再粘贴图片。`,admin:"管理员"}};const o=async()=>{try{const{pageviewCount:e}=await r(()=>import("./app-BgysoSG6.js").then(i=>i.M),__vite__mapDeps([]));return e({serverURL:t.serverURL})}catch{console.error("@waline/client is not installed!")}};export{o as updatePageview};
